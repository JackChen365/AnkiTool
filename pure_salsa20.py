...
"""
    ...
    pure_salsa20.py -- a pure Python implementation of the Salsa20 cipher, ported to Python 3
    ...
    pure_salsa20.py and testSalsa20.py are EXPERIMENTAL software and
    intended for educational purposes only.  To make experimentation less 
    cumbersome, pure_salsa20.py and testSalsa20.py are free for any use.
